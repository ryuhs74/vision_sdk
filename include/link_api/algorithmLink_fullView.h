 ...
 * \defgroup ALGORITHM_LINK_fullView_API Algorithm Plugin: Frame Copy API
 *
...
#ifndef _ALGORITHM_LINK_FULLVIEW_H_
#define _ALGORITHM_LINK_FULLVIEW_H_
...
typedef enum
{
    ALGORITHM_LINK_ALG_CPUFULLVIEW = 0,
    /**< Frame copy by CPU */
    ALGORITHM_LINK_ALG_DMAFULLVIEW,
    /**< Frame copy by DMA */
    ALGORITHM_LINK_ALG_FULLVIEW_FORCE32BITS = 0x7FFFFFFF
    /**< This should be the last value after the max enumeration value.
     *   This is to make sure enum size defaults to 32 bits always regardless
     *   of compiler.
     */
} AlgorithmLink_ViewMode;
...
typedef struct
{
    ...
    UInt32*					  pLut;
} AlgorithmLink_FullViewCreateParams;
...
} AlgorithmLink_fullViewControlParams;

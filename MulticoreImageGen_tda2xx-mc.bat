...
set App_MPU_CPU0=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_a15_0_debug.xa15fg
set App_MPU_CPU1=
REM App_MPU_SMP is to define MPU SMP application, To enable SMP mode - remove "App_MPU_CPU0" & set "APP_MPU_SMP"
REM set APP_MPU_SMP=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_a15_0_debug.xa15fg

...
#define UTILS_DSP1_XBAR_OFFSET                    (32-1)
 ...
 *******************************************************************************
 */
#define UTILS_DMA_SYS_EDMA_HWI_INT_XFER_COMP   (8)
#define UTILS_DMA_SYS_EDMA_HWI_INT_CC_ERR      (8)
#define UTILS_DMA_SYS_EDMA_HWI_INT_TC0_ERR     (8)
#define UTILS_DMA_SYS_EDMA_HWI_INT_TC1_ERR     (8)
...
UInt32 Utils_edma3GetRegionId(unsigned int edmaInstId)
{
    if(edmaInstId==UTILS_DMA_SYSTEM_EDMA_INST_ID)
        return UTILS_DMA_SYSTEM_DMA_DSP1_REGION;

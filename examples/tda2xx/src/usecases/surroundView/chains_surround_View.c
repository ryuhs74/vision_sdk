    ...
    while(!done)
    {
        ...
        switch(ch)
        {
            ...
            case '3':
            	...
            	System_linkControl(svChainsObj.ucObj.GrpxSrcLinkID , SYSTEM_CMD_REAR_SIDE_VIEW, NULL, 0, TRUE); //gGrpxSrcLinkID ��ü�� �ΰ�.
            	Vps_printf("   CMD Send chains_main\n");
            	break;
            case '4':
            	Vps_printf("In chains_main, SYSTEM_CMD_LEFT_SIDE_VIEW\n");
            	System_linkControl(svChainsObj.ucObj.GrpxSrcLinkID, SYSTEM_CMD_LEFT_SIDE_VIEW, NULL, 0, TRUE); //gGrpxSrcLinkID ��ü�� �ΰ�.
            	Vps_printf("   CMD Send chains_main\n");
            	break;
            case '5':
            	break;

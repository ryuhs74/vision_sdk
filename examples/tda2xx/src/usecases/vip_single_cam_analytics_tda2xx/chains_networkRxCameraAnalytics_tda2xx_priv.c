...
Void chains_networkRxCameraAnalytics_tda2xx_SetLinkId(chains_networkRxCameraAnalytics_tda2xxObj *pObj){
       ...
       pObj->IPCOut_A15_0_IPU1_0_2LinkID    = A15_0_LINK (SYSTEM_LINK_ID_IPC_OUT_2);
       pObj->IPCIn_IPU1_0_A15_0_3LinkID     = IPU1_0_LINK (SYSTEM_LINK_ID_IPC_IN_3);
...
Void chains_networkRxCameraAnalytics_tda2xx_ResetLinkPrms(chains_networkRxCameraAnalytics_tda2xxObj *pObj){
       ...
       IpcLink_CreateParams_Init(&pObj->IPCOut_A15_0_IPU1_0_2Prm);
       IpcLink_CreateParams_Init(&pObj->IPCIn_IPU1_0_A15_0_3Prm);
...
Void chains_networkRxCameraAnalytics_tda2xx_ConnectLinks(chains_networkRxCameraAnalytics_tda2xxObj *pObj){
       ...
       pObj->Alg_SparseOpticalFlowDrawPrm.outQueParams.nextLink = pObj->IPCOut_A15_0_IPU1_0_2LinkID;
       pObj->IPCOut_A15_0_IPU1_0_2Prm.inQueParams.prevLinkId = pObj->Alg_SparseOpticalFlowDrawLinkID;
       pObj->IPCOut_A15_0_IPU1_0_2Prm.inQueParams.prevLinkQueId = 0;

       //IPCOut_A15_0_IPU1_0_2 -> IPCIn_IPU1_0_A15_0_3
       pObj->IPCOut_A15_0_IPU1_0_2Prm.outQueParams.nextLink = pObj->IPCIn_IPU1_0_A15_0_3LinkID;
       pObj->IPCIn_IPU1_0_A15_0_3Prm.inQueParams.prevLinkId = pObj->IPCOut_A15_0_IPU1_0_2LinkID;
       pObj->IPCIn_IPU1_0_A15_0_3Prm.inQueParams.prevLinkQueId = 0;

       //IPCIn_IPU1_0_A15_0_3 -> Merge_alg
       pObj->IPCIn_IPU1_0_A15_0_3Prm.outQueParams.nextLink = pObj->Merge_algLinkID;
       pObj->Merge_algPrm.inQueParams[2].prevLinkId = pObj->IPCIn_IPU1_0_A15_0_3LinkID;
       ...
       pObj->Alg_LaneDetectDrawPrm.outQueParams.nextLink = pObj->IPCOut_A15_0_IPU1_0_1LinkID;
       pObj->IPCOut_A15_0_IPU1_0_1Prm.inQueParams.prevLinkId = pObj->Alg_LaneDetectDrawLinkID;
...
Int32 chains_networkRxCameraAnalytics_tda2xx_Create(chains_networkRxCameraAnalytics_tda2xxObj *pObj, Void *appObj){
       ...
       chains_networkRxCameraAnalytics_tda2xx_SetLinkId(pObj);
       chains_networkRxCameraAnalytics_tda2xx_ResetLinkPrms(pObj);

       chains_networkRxCameraAnalytics_tda2xx_SetPrms(pObj);
       chains_networkRxCameraAnalytics_tda2xx_SetAppPrms(pObj, appObj);

       chains_networkRxCameraAnalytics_tda2xx_ConnectLinks(pObj);
       ...
       status = System_linkCreate(pObj->IPCOut_A15_0_IPU1_0_2LinkID, &pObj->IPCOut_A15_0_IPU1_0_2Prm, sizeof(pObj->IPCOut_A15_0_IPU1_0_2Prm));
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkCreate(pObj->IPCIn_IPU1_0_A15_0_3LinkID, &pObj->IPCIn_IPU1_0_A15_0_3Prm, sizeof(pObj->IPCIn_IPU1_0_A15_0_3Prm));
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_networkRxCameraAnalytics_tda2xx_Start(chains_networkRxCameraAnalytics_tda2xxObj *pObj){
       ...
       status = System_linkStart(pObj->IPCIn_IPU1_0_A15_0_3LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkStart(pObj->IPCOut_A15_0_IPU1_0_2LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_networkRxCameraAnalytics_tda2xx_Stop(chains_networkRxCameraAnalytics_tda2xxObj *pObj){
       ...
       status = System_linkStop(pObj->IPCIn_IPU1_0_A15_0_3LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkStop(pObj->IPCOut_A15_0_IPU1_0_2LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_networkRxCameraAnalytics_tda2xx_Delete(chains_networkRxCameraAnalytics_tda2xxObj *pObj){
       ...
       status = System_linkDelete(pObj->IPCIn_IPU1_0_A15_0_3LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkDelete(pObj->IPCOut_A15_0_IPU1_0_2LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Void chains_networkRxCameraAnalytics_tda2xx_printBufferStatistics(chains_networkRxCameraAnalytics_tda2xxObj *pObj){
       ...
       System_linkPrintBufferStatistics(pObj->IPCOut_A15_0_IPU1_0_2LinkID);
       Task_sleep(500);
       System_linkPrintBufferStatistics(pObj->IPCIn_IPU1_0_A15_0_3LinkID);
...
Void chains_networkRxCameraAnalytics_tda2xx_printStatistics(chains_networkRxCameraAnalytics_tda2xxObj *pObj){
       ...
       System_linkPrintStatistics(pObj->IPCOut_A15_0_IPU1_0_2LinkID);
       Task_sleep(500);
       System_linkPrintStatistics(pObj->IPCIn_IPU1_0_A15_0_3LinkID);

...
export TICOMPONENTSBASE=/datalocal1
...
cp $STARTERWAREDIRNAME/binary/qspiFlashWriter/bin/tda2xx-mc/qspiFlashWriter_m4_release.xem4 $Sbl_Out_Path/qspiFlashWriter_m4_release.xem4

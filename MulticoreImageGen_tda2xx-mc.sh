...
export App_MPU_CPU0=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_a15_0_debug.xa15fg
export App_MPU_CPU1=
# App_MPU_SMP is to define MPU SMP application, To enable SMP mode - remove "App_MPU_CPU0" & set "APP_MPU_SMP"
# export APP_MPU_SMP=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_a15_0_debug.xa15fg
